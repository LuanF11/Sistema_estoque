...
class StockService:
    ...
    def entrada_produto(self, produto_id: int, quantidade: int, valor_unitario: float, observacao: str = ""):
        if quantidade <= 0:
    ...
    def saida_produto(self, produto_id: int, quantidade: int, observacao: str = ""):
        if quantidade <= 0:
